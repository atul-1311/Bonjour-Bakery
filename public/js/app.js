...
function updateCart(bakeryitem) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', bakeryitem).then(function (res) {
    ...
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      ...
      progressBar: true // layout: 'topleft'   to put it on left side of home page.
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var bakeryitem = JSON.parse(btn.dataset.bakeryitem);
...
socket.on('orderUpdated', function (data) {
  ...
  new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
    ...
    //1000 ms= 1 sec
    text: 'Order Updated',
    progressBar: false // layout: 'topleft'   to put it on left side of home page.
...
__webpack_require__(/*! D:\Work\Web dev\project2\realtime-cake\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Work\Web dev\project2\realtime-cake\resources\scss\app.scss */"./resources/scss/app.scss");
